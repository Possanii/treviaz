import CalendarHeaderActionsAddLeisureArea from '@/components/calendar/header/actions/calendar-header-actions-add-leisure-area'
    ...
    >
      <CalendarHeader>
        ...
        <CalendarHeaderActions>
          ...
          <CalendarHeaderActionsAddLeisureArea />
